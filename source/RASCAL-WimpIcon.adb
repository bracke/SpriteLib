...
--   end Icon_Data;
   ...
   procedure Change_Colour (Window     : in Wimp_Handle_Type;
                            Icon       : in Icon_Handle_Type;
                            Background : in Integer;
                            Foreground : in Integer) is
   begin
      if Foreground = -1 then
         Set_State(Window,Icon,Background * 2**28,Utility.Unsigned_To_Int(16#F0000000#));
      elsif Background = -1 then
         Set_State(Window,Icon,Foreground * 2**24,16#0F000000#);
      else
         Set_State(Window,Icon,Background * 2**28 + Foreground * 2**24,Utility.Unsigned_To_Int(16#FF000000#));
      end if;
   end Change_Colour;
